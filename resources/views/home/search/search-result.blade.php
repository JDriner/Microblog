...
<x-app-layout>
    ...
    <div class="max-w-xl mx-auto">
        <h1 class="text-xs text-slate-900 dark:text-white mt-4">No results found related to "{{ $search }}"</h1>
    </div>
    @endif
    @if (!$users->isEmpty())
        <!-- Display Results for Users -->
        <div class="max-w-xl mx-auto">
            <h1 class="text-xs text-slate-900 dark:text-white mt-4">Users related to "{{ $search }}"</h1>
    ...
    @include('post.partials.modal-post')
        ...
        <div class="max-w-xl mx-auto">
            <h1 class="text-xs text-slate-900 dark:text-white mt-4">Posts related to "{{ $search }}"</h1>
