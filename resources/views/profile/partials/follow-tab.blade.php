...
<div class="max-w-2xl mx-auto">
        ...
        <ul class="flex flex-wrap -mb-px" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
            ...
            <li class="mr-2" role="presentation">
                <button
                    ...
                    aria-controls="follower" aria-selected="true">Followers</button>
            </li>
            <li class="mr-2" role="presentation">
                <button
                    class="inline-block text-gray-500 hover:text-gray-600 hover:border-gray-300 rounded-t-lg py-4 px-4 text-sm font-medium text-center border-transparent border-b-2 dark:text-gray-400 dark:hover:text-gray-300"
    ...
    <div id="myTabContent">
        <div class="p-4 hidden" id="all" role="tabpanel"
            aria-labelledby="all-tab">
            <p class="text-gray-500 dark:text-gray-400 text-sm">All Users (following and followers)</p>
        </div>

        <div class="p-4" id="follower" role="tabpanel"
        ...
        <div class="p-4 hidden" id="following" role="tabpanel"
        ...
        <div class="p-4 hidden" id="suggested" role="tabpanel"
