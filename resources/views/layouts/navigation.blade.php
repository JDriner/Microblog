            ...
            <div class="flex">
                ...
                <div class="flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center">
                        <img src="{{ asset('images/clarity logo.png') }}" class="block h-10 w-auto fill-current "
                            alt="Logo">
                        <p class="text-xl font-black text-gray-800 dark:text-gray-200">Clarity Journal</p>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('listFollows', 'all')" :active="request()->routeIs('listFollows')">
