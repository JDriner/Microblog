            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <form action="" method="POST" name="postForm" id="postForm" enctype="multipart/form-data"
                        hidden>
                        @csrf
                        <div class="mt-4 w-full flex justify-center items-center" id="shared_post_content" hidden="hidden">
                    ...
                    <div class="px-4 py-4 sm:px-6 sm:flex sm:flex-row-reverse" id="delete_post_modal_btn"
                        hidden="hidden">
